  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: const [BeymenNavBar(),TheOneNavBar(), TheOneGoldMain(), BeymenFooter()],
        ),
      ),
    );
  }
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              _navItem(context, "BEIGE", textStyle, const GoldPage()),
...
class TheOneGoldMain extends StatelessWidget {
  const TheOneGoldMain({super.key});
          ...
          Row(
            children: [
              ...
              SizedBox(
                ...
                child: Column(
                  children: [
                    Image.asset("img/theOnePage/goldheader.jpg", fit: BoxFit.cover),
                    Image.asset(
                      "img/theOnePage/gold1.png",
                      fit: BoxFit.cover,
                    ),
                  ],
                ),
