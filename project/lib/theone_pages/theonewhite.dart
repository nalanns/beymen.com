  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: const [BeymenNavBar(),TheOneNavBar(), TheOneWhiteMain(), BeymenFooter()],
        ),
      ),
    );
  }
...
class TheOneWhiteMain extends StatelessWidget {
  const TheOneWhiteMain({super.key});
          ...
          Row(
            children: [
              ...
              SizedBox(
                ...
                child: Column(
                  children: [
                    Image.asset("img/theOnePage/whiteheader.jpg", fit: BoxFit.cover),
                    Image.asset(
                      "img/theOnePage/white1.png",
                      fit: BoxFit.cover,
                    ),
                  ],
                ),
