...
void main() {
  runApp(const PlatiniumPage());
}

class PlatiniumPage extends StatelessWidget {
  const PlatiniumPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: const [BeymenNavBar(),TheOneNavBar(), TheOnePlatMain(), BeymenFooter()],
        ),
      ),
    );
  }
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              _navItem(context, "BEIGE", textStyle, const PlatiniumPage()),
...
class TheOnePlatMain extends StatelessWidget {
  const TheOnePlatMain({super.key});
          ...
          Row(
            children: [
              ...
              SizedBox(
                ...
                child: Column(
                  children: [
                    Image.asset("img/theOnePage/platheader.jpg", fit: BoxFit.cover),
                    Image.asset(
                      "img/theOnePage/plat1.png",
                      fit: BoxFit.cover,
                    ),
                  ],
                ),
