...
void main() {
  runApp(const BeigePage());
}

class BeigePage extends StatelessWidget {
  const BeigePage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: const [BeymenNavBar(),TheOneNavBar(), TheOneBeigeMain(), BeymenFooter()],
        ),
      ),
    );
  }
...
class TheOneBeigeMain extends StatelessWidget {
  const TheOneBeigeMain({super.key});
          ...
          Row(
            children: [
              ...
              SizedBox(
                ...
                child: Column(
                  children: [
                    Image.asset("img/theOnePage/beigeheader.jpg", fit: BoxFit.cover),
                    Image.asset(
                      "img/theOnePage/beige1.png",
                      fit: BoxFit.cover,
                    ),
                  ],
                ),
