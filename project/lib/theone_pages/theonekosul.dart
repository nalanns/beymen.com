...
void main() {
  runApp(const KosulPage());
}

class KosulPage extends StatelessWidget {
  const KosulPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: const [BeymenNavBar(),TheOneNavBar(), TheOneKosulMain(), BeymenFooter()],
        ),
      ),
    );
  }
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              _navItem(context, "BEIGE", textStyle, const KosulPage()),
...
class TheOneKosulMain extends StatelessWidget {
  const TheOneKosulMain({super.key});
          ...
          Row(
            children: [
              ...
              SizedBox(
                ...
                child: Column(
                  children: [
                    Image.asset("img/theOnePage/kosulheader.jpg", fit: BoxFit.cover),
                    Image.asset(
                      "img/theOnePage/kosul1.png",
                      fit: BoxFit.cover,
                    ),
                  ],
                ),
