  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: const [BeymenNavBar(),TheOneNavBar(), TheOneVipMain(), BeymenFooter()],
        ),
      ),
    );
  }
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              _navItem(context, "BEIGE", textStyle, const VipPage()),
...
class TheOneVipMain extends StatelessWidget {
  const TheOneVipMain({super.key});
          ...
          Row(
            children: [
              ...
              SizedBox(
                ...
                child: Column(
                  children: [
                    Image.asset("img/theOnePage/vipheader.jpg", fit: BoxFit.cover),
                    Image.asset(
                      "img/theOnePage/vip1.png",
                      fit: BoxFit.cover,
                    ),
                  ],
                ),
