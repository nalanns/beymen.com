...
void main() {
  runApp(const TheOnePage());
}

class TheOnePage extends StatelessWidget {
  const TheOnePage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: const [BeymenNavBar(),TheOneNavBar(), TheOneMain(), BeymenFooter()],
        ),
      ),
    );
  }
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              _navItem(context, "BEIGE", textStyle, const BeigePage()),
...
class TheOneMain extends StatelessWidget {
  const TheOneMain({super.key});
          ...
          Row(
            children: [
              ...
              SizedBox(
                ...
                child: Column(
                  children: [
                    Image.asset("img/theOnePage/header.jpg", fit: BoxFit.cover),
                    Image.asset(
                      "img/theOnePage/Untitled.png",
                      fit: BoxFit.cover,
                    ),
                    Image.asset(
                      "img/theOnePage/Untitled2.png",
                      fit: BoxFit.cover,
                    ),
                  ],
                ),
