  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(children: const [BeymenNavBar(),ServicesPageMain(), BeymenFooter()]),
      ),
    );
  }
}
...
class ServicesPageMain extends  StatelessWidget {
  const ServicesPageMain({super.key});
